...
public class testPdfUtility {
	...
	public static void readFieldValues() {
		String sSrc = "/media/veracrypt2/william.fromtw@gmail.com/Dropbox/git/src/inmethod/Java/InMethodJakarta/test_files/certificate/2QP0502.pdf";
		try {
		    ...
		    System.out.println(aPdfUtility.getFieldValue("中文測試"));
