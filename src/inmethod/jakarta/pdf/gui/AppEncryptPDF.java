			...
			public void actionPerformed(ActionEvent e) {
				...
				if( bSuccess) {
					if( passwordUser.getPassword().length==0)
						bSuccess = EncryptPDF.getInstance().encryptFile(txtSource.getText() , txtDest.getText(),null , toBytes(passwordOwner.getPassword() ));
					else
						bSuccess = EncryptPDF.getInstance().encryptFile(txtSource.getText() , txtDest.getText(),toBytes(passwordUser.getPassword()) , toBytes(passwordOwner.getPassword() ));
					if( bSuccess)
